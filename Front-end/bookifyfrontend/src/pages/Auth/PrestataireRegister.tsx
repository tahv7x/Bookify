              ...
              <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 w-full max-w-md lg:max-w-lg">
                ...
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-[#28282B] to-[#1f1f22] hover:from-[#1f1f22] hover:to-[#28282B] text-white py-3.5 rounded-xl font-semibold  transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed text-sm md:text-base"
                  >
